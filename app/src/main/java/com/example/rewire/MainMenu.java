...
// MainMenu is a subclass of App class
// It is used to control the main menu
public class MainMenu extends App {
    Button cbt, bt;

    // Called when the interface of main menu is starting
    // Read file to restore previous progress if it exists
    // Activate the header
    // Play background music
    // Set button listeners of breathing technique and CBT
    @Override
